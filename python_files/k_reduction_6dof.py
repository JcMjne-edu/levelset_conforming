...
def reduction(ke3,ke4,connect3,connect4,nnode,surface_nid,spc_nid):
  """
  ...
  surface_nid : surface node ids\n
  """
  kg=_Kg(ke3,ke4,connect3,connect4,nnode)
  active_dim=(surface_nid.repeat(3).reshape(-1,3)*6+jnp.arange(3)).flatten()
...
def reduction_z(ke3,ke4,connect3,connect4,nnode,surface_nid,spc_nid):
  """
  Calculate reduced stiffness matrix using Guyan reduction\n
